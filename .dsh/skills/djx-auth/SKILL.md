...
description: >-
  ...
  Related skills: djx-install (installation), djx-local-model (local models), data-juicer (main flow).
...
See **djx-local-model** skill for details. Quick configuration:
...
|----------|--------------|
| Install environment | djx-install |
| Configure API Key / model | **djx-auth (this skill)** |
| Configure local models | djx-local-model |
