...
description: >-
  ...
  Related skills: data-juicer (main flow), djx-plan (integrating custom operators).
...
|----------|--------------|
| Search for existing operators | djx-retrieve |
| Develop custom operators | **djx-dev (this skill)** |
| Integrate into pipeline | djx-plan |
