...
description: >-
  ...
  Related skills: djx-auth (authentication), data-juicer (main flow).
...
See **djx-auth** skill for details.
...
|----------|--------------|
| Installation / environment issues | **djx-install (this skill)** |
| Authentication / API Key configuration | djx-auth |
