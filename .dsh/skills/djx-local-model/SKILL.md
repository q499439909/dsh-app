...
description: >-
  ...
  Related skills: djx-auth (authentication), data-juicer (main flow), djx-retrieve (local retrieval).
...
|----------|--------------|
| Configure API Key (cloud) | djx-auth |
| Configure local models | **djx-local-model (this skill)** |
| Local operator retrieval | djx-retrieve (retrieve_operators, already local) |
